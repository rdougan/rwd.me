    ...
    def self.included( recipient )
      ...
      recipient.class_eval do
        ...
        aasm_event :suspend do
          transitions :from => [:passive, :pending, :active, :approved], :to => :suspended
        end
        
        aasm_event :delete do
          transitions :from => [:passive, :pending, :active, :suspended, :approved], :to => :deleted
        end

        aasm_event :unsuspend do
          transitions :from => :suspended, :to => :approved, :guard => Proc.new {|u| !u.activated_at.blank? }
